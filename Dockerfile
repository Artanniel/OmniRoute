...
RUN --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/var/cache/apt,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/var/lib/apt/lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
RUN --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/root/.npm,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/app/.build/next/cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/var/cache/apt,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/aab0b27c-a141-407e-a319-380e0be4dec9-/var/lib/apt/lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
