...
RUN --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/var/cache/apt,target=/var/cache/apt,sharing=shared \
  --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/var/lib/apt/lists,target=/var/lib/apt/lists,sharing=shared \
  apt-get update \
  && apt-get upgrade -y \
...
RUN --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/root/.npm,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/app/.build/next/cache,target=/app/.build/next/cache \
...
RUN --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/var/cache/apt,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/8c865e17-457e-4109-bf2c-9d75f90f35cc-/var/lib/apt/lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
